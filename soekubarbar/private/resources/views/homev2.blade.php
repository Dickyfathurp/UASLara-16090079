    ...
    <div class="bg-color">
          ...
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="mynavbar">
              <ul class="nav navbar-nav">
               <li class="active"><a href="{{ url('homev2') }}">Home</a></li>
                	<li class="active"><a href="{{ url('pembayaran') }}">Pembayaran</a></li>
                		<li class="active"><a href="{{ url('pesan') }}">Pemesanan</a></li>
                			<li class="active"><a href="{{ url('masuk') }}">Login</a></li>
                				<li class="active"><a href="{{ url('tentang') }}">About</a></li>
      ...
      <div class="container text-center">
        <div class="wrapper wow fadeInUp delay-05s">
          ...
          <h4 class="sub-title">Siap Mengantarkan Anda Dengan Senang Hati!</h4>
        </div>
      </div>
    </div>
  </header>
        ...
        <div class="col-md-12 col-sm-12">
          ...
          <div class="col-md-4 col-sm-6">
            ...
            <div class="location-info">
              ...
              <p class="white"><span aria-hidden="true" class="fa fa-phone"></span>Phone: 0839 333 12 68 347</p>
              <p class="white"><span aria-hidden="true" class="fa fa-envelope"></span>Email: <a href="" class="link-dec">fathoer67@gmail.com</a></p>
            </div>
          </div>
          <div class="col-md-4">
